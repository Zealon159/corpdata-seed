package com.corpdata.common.result.util;
...
public class ResultUtil {
    ...
    public static Result success() {
        return new Result(HttpCodeEnum.OK.getCode(),null, HttpCodeEnum.OK.getMessage());
    }
    ...
    public static Result success(Object data) {
        return new Result(HttpCodeEnum.OK.getCode(), null,data);
    }
    ...
    public static Result fail(Object data) {
        return new Result(HttpCodeEnum.FAIL.getCode(), null,data);
    }
