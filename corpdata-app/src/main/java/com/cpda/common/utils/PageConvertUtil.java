...
public class PageConvertUtil {
	...
	public static String getEasyuiJson(Page<?> list){
		...
		jsonData.append("{");
		jsonData.append("\"total\":").append(list.getTotal());
		jsonData.append(",\"rows\":").append(JSON.toJSONStringWithDateFormat(list,"yyyy-MM-dd"));
		jsonData.append("}");
