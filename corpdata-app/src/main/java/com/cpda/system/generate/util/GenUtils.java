package com.cpda.system.generate.util;

import com.cpda.common.utils.BDException;
import com.cpda.common.utils.DateUtils;
import com.cpda.system.generate.domain.ColumnDO;
import com.cpda.system.generate.domain.TableDO;
...
public class GenUtils {
    ...
    public static void generatorCode(Map<String, Object> table,
        ...
        map.put("classname", tableDO.getClassname());
        map.put("pathName", packageName2.replace(".", "/"));
        ...
        for (String template : templates) {
            ...
            try {
                //添加到zip
                zip.putNextEntry(new ZipEntry(getFileName(template, tableDO.getClassname(), tableDO.getClassName(), packageName2.replace(".", "/"))));
    ...
    public static Configuration getConfig() {
        try {
            return new PropertiesConfiguration("config/properties/generator.properties");
